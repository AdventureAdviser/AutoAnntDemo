...
"")
        ...
        # Инициализация QLabel для отображения изображений
        self.photo_widget = QLabel(self.photo_page)
        self.photo_widget.setObjectName("photo_widget")
        self.photo_widget.setStyleSheet("max-height: 10000000px")
        self.photo_widget.setScaledContents(True)  # Изображение растягивается на всю доступную область

        # Добавление photo_widget в gridLayout_13, занимающего большую часть пространства
        self.gridLayout_13.addWidget(self.photo_widget, 0, 0, 1, 1)
        self.gridLayout_13.setRowStretch(0, 1)  # Задаем большой коэффициент растяжения для строки с изображением

        # Конфигурация горизонтальной компоновки для кнопок
        ...
        # Добавление horizontalLayout_7 в gridLayout_13 под photo_widget
        self.gridLayout_13.addLayout(self.horizontalLayout_7, 1, 0, 1, 1)
        self.gridLayout_13.setRowStretch(1, 0)  # Фиксированная высота для строки с кнопками

        # Добавление photo_page в stackedWidget и расположение в layout
