...
#         self.photo_widget = QLabel(self.photo_page)  # Измените на QLabel
#         # self.photo_widget.setObjectName(u"photo_widget")
...
#
#         # self.verticalSpacer_5 = QSpacerItem(20, 370, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
#
#         # self.gridLayout_12.addItem(self.verticalSpacer_5, 0, 1, 1, 1)
#
#         # self.horizontalSpacer_5 = QSpacerItem(486, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
#
#         # self.gridLayout_12.addItem(self.horizontalSpacer_5, 1, 0, 1, 1)
#
#         # self.horizontalSpacer_6 = QSpacerItem(486, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
#
#         # self.gridLayout_12.addItem(self.horizontalSpacer_6, 1, 2, 1, 1)
#
#         # self.verticalSpacer_6 = QSpacerItem(20, 370, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
#
#         # self.gridLayout_12.addItem(self.verticalSpacer_6, 2, 1, 1, 1)
#
#         self.label_9 = QLabel(self.photo_widget)
...
#         self.stackedWidget.addWidget(self.photo_page)
        ...
        self.photo_widget.setObjectName(u"photo_widget")
        self.photo_widget.setStyleSheet(u"")
